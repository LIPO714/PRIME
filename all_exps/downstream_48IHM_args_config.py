...
def parse_args():
    ...
    parser.add_argument("--exp_name", type=str, default="exp_12_down_ihm_1.0_impute&(mtand&mvand)_a0.5_b0.5_pre18_0626")  # exp_12_down_ihm_1.0_impute&(mtand&mvand)_a0.5_b0.25_pre16_0604
