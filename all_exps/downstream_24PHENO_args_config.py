...
def parse_args():
    ...
    parser.add_argument("--exp_name", type=str, default="24pheno-test")
    parser.add_argument("--seed", type=int, default=42)

    parser.add_argument("--task", type=str, default='24pheno')
    ...
    # ts data
    parser.add_argument("--ts_max_len", type=int, default=100)
    ...
    parser.add_argument("--class_lr", type=float, default=0.0004)
    ...
    parser.add_argument("--num_update_bert_epochs", type=int, default=1)
    parser.add_argument("--bertcount", type=int, default=8)
