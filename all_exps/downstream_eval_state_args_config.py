...
def parse_args():
    ...
    parser.add_argument("--exp_name", type=str, default="exp_12_eval_state_impute&(mtand&mvand)_a0.5_b0.5_pre17_0617")  # exp_12_down_ihm_1.0_impute&(mtand&mvand)_a0.5_b0.25_pre16_0604
    parser.add_argument("--seed", type=int, default=42)

    parser.add_argument("--task", type=str, default='eval_state')  # 48ihm 24pheno
    ...
    # 多卡训练python main.py --init_method tcp://localhost:26688 -g 2 --rank 0 --world_size 1
    parser.add_argument('--init_method', default='tcp://localhost:26688', help="init-method")
    ...
    parser.add_argument('--world_size', default=1, type=int, help="world size")  # 一共几张卡
    ...
    parser.add_argument("--conti_impute_type", type=str, default="linear", choices=["linear", "backward",
    ...
    parser.add_argument("--other_lr", type=float, default=0.0001)  # 没用
    parser.add_argument("--bert_lr", type=float, default=0.00001)  # 没用
    parser.add_argument("--class_lr", type=float, default=0.0005)  # 0.0005
    ...
    # parser.add_argument("--pretrain_model", type=str,
    #                     default="./save/pretrain/exp_12_new_structure_impute&(mtand&mvand)_a0.5_b0.75_0604_seed_42_percent_1.0_epoch_20_batch_3_bioLongformer512_bert_update_2_10_notenum_4_emb_dim_128_bert_lr_2e-05_other_lr_0.0004/17.pth")
    ...
    parser.add_argument("--full_model", type=str,
                        default="./save/48ihm/exp_12_down_ihm_impute&(mtand&mvand)_pre18_0528_seed_42_percent_1.0_epoch_40_batch_32_bioLongformer512_bert_update_2_3_notenum_20_emb_dim_128_bert_lr_1e-05_other_lr_0.0001_class_lr_0.0005/9.pth")
    ...
    # model restore
    parser.add_argument("--ts_restore_len", type=int, default=6)  # l
    ...
    parser.add_argument("--alpha", type=float, default=0.5)  # 0.5  # if loss=="CONT+RESTORE"
    parser.add_argument("--beta", type=float, default=0.5)  # 0.25  # if loss=="CONT+RESTORE"
